...
export default function CardDetails({allNotes, getAllNotes}) {
 ...
 async function addFun(e){
    e.preventDefault()
    let {data} = await axios.put(`https://movies-api.routemisr.com/updateNote`,updateData )
    console.log(data);
    getAllNotes()
  ...
  async function deleteCard(id){
    ...
    console.log(delCard);
    let {data} = await axios.delete(`https://movies-api.routemisr.com/deleteNote`, {data:delCard})
    console.log(data);
    getAllNotes()
  }
  return (
